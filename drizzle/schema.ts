...
export const agencyProfiles = mysqlTable("agencyProfiles", {
  ...
  reviewSectionTitle: varchar("reviewSectionTitle", { length: 160 }),
  reviewSectionIntro: varchar("reviewSectionIntro", { length: 500 }),
  reviewCtaLabel: varchar("reviewCtaLabel", { length: 80 }),
  reviewCtaEnabled: boolean("reviewCtaEnabled").notNull().default(true),
