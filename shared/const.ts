...
// Administrator access tokens are intentionally short-lived. Account changes and
// administrator deactivation also advance `lastSignedIn`, invalidating existing tokens.
export const ADMIN_SESSION_TTL_MS = 1000 * 60 * 30;
