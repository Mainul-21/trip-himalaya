  ...
  return <div className="min-h-screen overflow-hidden bg-[#fbfaf6]">
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/55 bg-[#f7faf7]/74 shadow-[0_8px_26px_rgba(18,61,91,.08)] backdrop-blur-2xl backdrop-saturate-150">
      <div className="container flex h-20 items-center justify-between gap-4">
        ...
        <div className="hidden items-center gap-3 lg:flex"><SearchField /><Link href="/contact" className="focus-ring inline-flex h-12 min-w-[178px] items-center justify-center gap-2 rounded-lg border border-[#d76d17] bg-[#e9781c] px-5 text-[.74rem] font-extrabold uppercase tracking-[.08em] text-white shadow-[0_9px_20px_rgba(191,88,12,.22)] transition-[background-color,box-shadow,transform] hover:bg-[#cf6513] hover:shadow-[0_11px_24px_rgba(191,88,12,.28)] active:scale-[.98]"><MessageCircle className="size-[1.1rem]" /> Plan your trip</Link></div>
