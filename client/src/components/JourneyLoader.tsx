  ...
  return <main className="relative grid min-h-screen place-items-center overflow-hidden bg-[#f8faf8] px-5 text-[#123d5b]" aria-busy="true" aria-live="polite">
    ...
    <div className="relative grid justify-items-center">
      <div className="relative grid size-28 place-items-center" aria-hidden="true">
        ...
        <span className="relative grid size-16 place-items-center rounded-full border border-white/80 bg-[#123d5b] shadow-[0_16px_32px_rgba(18,61,91,.18)]"><Compass className="size-8 text-[#f6a455]" strokeWidth={1.7} /></span>
        <span className="absolute -bottom-1 -right-1 grid size-7 place-items-center rounded-full bg-[#e17818] text-[10px] font-black text-white shadow-md">N</span>
      </div>
      <p className="mt-8 font-display text-2xl font-bold uppercase tracking-[.08em]">Finding the next horizon</p>
