...
export default function Home() {
  ...
  return <PublicLayout showHeader={false}>
    <section className="relative">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 pb-6 pt-14 sm:pt-20"><h1 className="font-display text-3xl font-bold leading-tight tracking-wide text-primary-foreground sm:text-5xl">DISCOVER HIMACHAL.<span className="mt-1 block text-accent">EXPERIENCE THE HIMALAYAS.</span></h1><p className="mt-4 text-sm text-primary-foreground/85">Curated journeys. Local expertise. Unforgettable memories.</p><div className="mt-7 flex flex-wrap gap-4"><a href="#packages" onClick={event => { event.preventDefault(); scrollToSection("packages"); }} className="focus-ring inline-flex items-center gap-3 rounded-md bg-accent px-6 py-3 text-sm font-semibold tracking-wide text-accent-foreground shadow-lg transition-transform hover:scale-[1.03]">EXPLORE TOURS <span className="grid h-6 w-6 place-items-center rounded-full border border-accent-foreground/60"><ArrowRight size={13} /></span></a><a href="#plan" onClick={event => { event.preventDefault(); scrollToSection("plan"); }} className="focus-ring inline-flex items-center gap-3 rounded-md bg-background px-6 py-3 text-sm font-semibold tracking-wide text-primary shadow-lg transition-transform hover:scale-[1.03]">PLAN YOUR TRIP <CalendarDays size={16} className="text-accent" /></a></div></div>
