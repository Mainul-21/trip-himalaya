...
export default function Home() {
  ...
  const reviewSectionIntro = agency?.reviewSectionIntro || "Stories published from real Trip Himalaya guests. Read independent feedback through the review source your team provides.";
